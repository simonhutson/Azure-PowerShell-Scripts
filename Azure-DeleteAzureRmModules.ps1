...
# Uninstall AzureRm modules, all versions
# https://docs.microsoft.com/powershell/azure/uninstall-az-ps
$AzureRmVersions = (Get-InstalledModule -Name "AzureRm" -AllVersions -ErrorAction SilentlyContinue -Verbose | Select-Object Version -Verbose)
if ($AzureRmVersions)
{
